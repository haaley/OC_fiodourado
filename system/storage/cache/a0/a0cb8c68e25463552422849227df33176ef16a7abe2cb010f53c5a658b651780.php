...
class __TwigTemplate_6fc6384c2af4e066ae41751c428b876e0e4f6dc4bb3a41e70d0579dc429a0664 extends Twig_Template
{
      ...
      ";
        ...
        if ((isset($context["ips"]) ? $context["ips"] : null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["ip"]) {
                // line 15
                echo "          <tr>
            <td class=\"text-left\"><a href=\"http://www.geoiptool.com/pt/?IP=";
                // line 16
...
/*         {% for ip in ips %}*/
/*           <tr>*/
/*             <td class="text-left"><a href="http://www.geoiptool.com/pt/?IP={{ ip.ip }}" target="_blank">{{ ip.ip }}</a></td>*/
