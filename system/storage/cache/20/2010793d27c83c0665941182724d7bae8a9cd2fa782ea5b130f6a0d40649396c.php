...
/* __string_template__1e16a09fdd2d53483ebf0aa28e061176d4db4fda0e17ded1f4d62adcd89e9a87 */
class __TwigTemplate_28a1a4309e646a9a5fdcd9c0fbe0af2397934016fa95e91e879ea676d6ec3acc extends Twig_Template
{
...
\t\t\t\t\t\t\t\t
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["custom_field"]) {
            ...
            if (($this->getAttribute($context["custom_field"], "type", array()) == "select")) {
                ...
                echo "\">
                    <label class=\"col-md-6\" for=\"input-custom-field";
                // line 113
                echo $this->getAttribute($context["custom_field"], "custom_field_id", array());
                echo "\">";
            ...
            if (($this->getAttribute($context["custom_field"], "type", array()) == "text")) {
                ...
                echo $this->getAttribute($context["custom_field"], "sort_order", array());
                echo "\">
                    <label class=\"col-md-6l\" for=\"input-custom-field";
                // line 183
                echo $this->getAttribute($context["custom_field"], "custom_field_id", array());
                echo "\">";
                echo $this->getAttribute($context["custom_field"], "name", array());
...
";
    ...
    {
        return "__string_template__1e16a09fdd2d53483ebf0aa28e061176d4db4fda0e17ded1f4d62adcd89e9a87";
    }
...
/*                     <label class="col-md-6">{{ entry_customer_group }}</label>*/
...
/*                     <label class="col-md-6" for="input-custom-field{{ custom_field.custom_field_id }}">{{ custom_field.name }}</label>*/
/*                     <div>*/
...
/*                   <div id="custom-field{{ custom_field.custom_field_id }}" class="form-group custom-field" data-sort="{{ custom_field.sort_order }}">*/
/*                     <label class="col-md-6">{{ custom_field.name }}</label>*/
/*                     <div >*/
...
/*                   <div id="custom-field{{ custom_field.custom_field_id }}" class="form-group custom-field" data-sort="{{ custom_field.sort_order }}">*/
/*                     <label class="col-md-6l" for="input-custom-field{{ custom_field.custom_field_id }}">{{ custom_field.name }}</label>*/
/*                     <div >*/
